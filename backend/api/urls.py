...
urlpatterns = [
    ...
    path('', include(router.urls)),  # Include URL patterns generated by the router
    path('task/<int:pk>/', views.TaskDetailView.as_view(), name='task-detail'),  # Add this line for task detail view
